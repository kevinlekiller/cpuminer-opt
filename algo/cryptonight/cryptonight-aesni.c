...
{
#ifndef NO_AES_NI
    keccak( (const uint8_t*)input, len, (char*)&ctx.state.hs.b, 200 );
    ...
    for (i = 0; i < MEMORY; i += INIT_SIZE_BYTE)
    {
        ...
        x = i >> 4;
        _mm_store_si128(&(longoutput[x    ]), xmminput[0]);
        _mm_store_si128(&(longoutput[x + 1]), xmminput[1]);
        _mm_store_si128(&(longoutput[x + 2]), xmminput[2]);
        _mm_store_si128(&(longoutput[x + 3]), xmminput[3]);
        _mm_store_si128(&(longoutput[x + 4]), xmminput[4]);
        _mm_store_si128(&(longoutput[x + 5]), xmminput[5]);
        _mm_store_si128(&(longoutput[x + 6]), xmminput[6]);
        _mm_store_si128(&(longoutput[x + 7]), xmminput[7]);
    }
    ...
    {
        x = i >> 4;
        xmminput[0] = _mm_xor_si128(longoutput[x    ], xmminput[0]);
        xmminput[1] = _mm_xor_si128(longoutput[x + 1], xmminput[1]);
        xmminput[2] = _mm_xor_si128(longoutput[x + 2], xmminput[2]);
        xmminput[3] = _mm_xor_si128(longoutput[x + 3], xmminput[3]);
        xmminput[4] = _mm_xor_si128(longoutput[x + 4], xmminput[4]);
        xmminput[5] = _mm_xor_si128(longoutput[x + 5], xmminput[5]);
        xmminput[6] = _mm_xor_si128(longoutput[x + 6], xmminput[6]);
        xmminput[7] = _mm_xor_si128(longoutput[x + 7], xmminput[7]);
